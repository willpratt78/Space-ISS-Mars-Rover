...
export class ISSTracker {
  ...
  static async getLocationsOfLandmarksFromIss(issLat, issLong) {
    ...
    let locationsArray = [[41.8902, 12.4922, "Colosseum"],[20.6843, 88.5678, "Chichén Itzá El Castillo"],[13.1631, 72.5450, "Machu Picchu"],[22.9519, 43.2105, "Christ the Reedemer"],[30.3285, 35.4444, "Petra"],[40.4319, 116.5704, "Great Wall of China"],[27.1751, 78.0421, "Taj Mahal"]];
